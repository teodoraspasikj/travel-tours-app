package mk.ukim.finki.traveltoursbackend.util;
...
public class CodeExtractor {
    public static void submitSourcesAndLogs() throws JsonProcessingException, UnknownHostException {
        ...
        if (backendSrcMain != null) {
            allSources.putAll(
                readFilesContent(findFilesWithExtensions(backendSrcMain, List.of(".java", ".properties", ".html"))));
        }

        File frontendSrc = findFirstMatchingFolder(projectRoot, "-frontend/src");
        if (frontendSrc != null) {
            allSources.putAll(readFilesContent(
                findFilesWithExtensions(frontendSrc, List.of(".js", ".jsx", ".ts", ".tsx", ".css", ".scss", ".html"))));
        }
